...
def plot_subset(turn_range, loaded_lists):
...
def widget(histories=None):
    ...
    def update_plot(change):
        plot_subset(change.new, loaded_lists)
    ...
    plot_subset(turns_slider.value, loaded_lists)
